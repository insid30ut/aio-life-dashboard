...
```bash
git remote add encore encore://aio-life-dashboard-zvei
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/aio-life-dashboard-zvei/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/aio-life-dashboard-zvei/settings/integrations/github)
